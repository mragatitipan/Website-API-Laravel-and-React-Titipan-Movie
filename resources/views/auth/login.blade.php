...
/* ============================================
   MOBILE DEVICES - FIXED SCROLL ISSUE
   ============================================ */
@media (max-width: 768px) {
  body {
    padding: 10px;
    overflow: auto; /* ✅ PENTING: Biarkan scroll */
    align-items: flex-start; /* ✅ Align ke atas, bukan center */
    padding-top: 20px;
    padding-bottom: 20px;
  }
  
  :root {
    --form-max-height: none; /* ✅ Hapus constraint height */
    --outline-width: 4px;
  }
  ...
  .auth-container {
    border-radius: 16px;
    max-width: 100%;
    height: auto !important; /* ✅ PENTING: Auto height */
    min-height: auto;
    max-height: none;
  ...
  .form-wrapper {
    height: auto; /* ✅ PENTING: Auto height */
    overflow: visible; /* ✅ PENTING: Biarkan scroll di body */
  }
  
  .form-scrollable-content {
    padding: 16px;
    overflow-y: visible; /* ✅ PENTING: Biarkan scroll di body */
    overflow-x: hidden;
    max-height: none;
  }
  ...
  .form-sticky-header {
    padding: 10px 16px;
    position: relative; /* ✅ Ubah dari sticky ke relative di mobile */
  }
  ...
  /* ✅ PERBAIKAN WHATSAPP PREVIEW */
  .whatsapp-preview {
    margin-top: 16px;
  }
  
  .whatsapp-message-bubble {
    max-height: 150px; /* ✅ Reduce height di mobile */
    font-size: 0.8rem;
  }
}
